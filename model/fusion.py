...
'''
AAFM
x1,x2,x3,x4: features in decoder
...
'''
    def __init__(self, base_chan):
        ...
        self.atrous1=nn.Conv2d(8*base_chan, base_chan, kernel_size=3,dilation=2, padding=2)
        self.atrous2=nn.Conv2d(4*base_chan, base_chan, kernel_size=3,dilation=3, padding=3)
        self.atrous3=nn.Conv2d(2*base_chan, base_chan, kernel_size=3,dilation=5,padding=5)
        self.atrous4=nn.Conv2d(  base_chan, base_chan, kernel_size=3,dilation=9,padding=9)
...
#class DF_fusion_block(nn.Module):
'''
feature fusion block without adaptive attention correction
x1,x2,x3,x4: features in decoder

'''
#    def __init__(self, base_chan):
#        super().__init__()
#        self.atrous1=nn.Conv2d(8*base_chan, 8*base_chan, kernel_size=3,dilation=2, padding=2)
#        self.atrous2=nn.Conv2d(4*base_chan, 4*base_chan, kernel_size=3,dilation=3, padding=3)
#        self.atrous3=nn.Conv2d(2*base_chan, 2*base_chan, kernel_size=3,dilation=5,padding=5)
#        self.atrous4=nn.Conv2d(  base_chan,   base_chan, kernel_size=3,dilation=9,padding=9)
